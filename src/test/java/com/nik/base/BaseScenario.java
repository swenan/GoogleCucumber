...
public class BaseScenario {
	...
	public WebDriver getDriver() {
		...
		if (envName.equalsIgnoreCase("local")) {
			...
			try {
				...
				// Wait for DOM to avoid `stale element reference: element is not attached to
				// the page document`
	...
	public String getSiteBaseUrl() {
		// System.out.println((String) System.getProperty("siteUrl"));
		// return (String) System.getProperty("siteUrl");
		return reader.getApplicationUrl();
	}

	/**
	 * Close Driver: delete all cookies for new session, tearDownClass() will handle
	 * closing the driver
	 */
